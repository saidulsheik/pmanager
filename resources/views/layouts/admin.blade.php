    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{(request()->is('user')) || (request()->is('user/*')) || (request()->is('role')) || (request()->is('role/*')) ||(request()->is('company')) || (request()->is('company/*'))? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/project')}}" class="nav-link {{(request()->is('project')) || (request()->is('project/*')) ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Project/Show List</p>
                </a>
              </li>
            </ul>
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{url('/task')}}" class="nav-link {{(request()->is('task')) || (request()->is('task/*')) ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Task/Show List</p>
                  </a>
                </li>
              </ul>
          </li>
