                                        ...
                                        {{!$i=1}} 
                                            @foreach ($roles as $role)
                                                ...
                                                <td>{{$i++}}</td>
                                                  ...
                                                  <td style="text-align:center"  title="Edit User Role"> <a href="{{ URL::to("role/$role->id/edit") }}"><i class="fas fa-edit" style="color:#007bff"></i></a> || <i class="fas fa-trash" style="color:red"  title="Delete User Role"></i></td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
